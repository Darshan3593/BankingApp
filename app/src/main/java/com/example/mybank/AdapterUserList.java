...
public class AdapterUserList extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.mybank.UserListActivity UserList;
    List<com.example.mybank.Model> modelList;

    public AdapterUserList(com.example.mybank.UserListActivity userList, List<com.example.mybank.Model> modelList) {
